...
public class Input implements Closeable, Iterator<String> {
   ...
   */
  public Input ( ) { this ( System.in ) ; }
  /** 
   * Constructor of an <code>Input</code> object given an <code>InputStream</code> object.
   */
  public Input ( final InputStream in ) { scanner = new Scanner ( in ) ; }
  /**
  ...
  public boolean hasNext ( ) {
    ...
    try { returnValue = scanner.hasNext ( ) ; }
  ...
  public String next ( ) {
    ...
    try { returnValue = scanner.next ( ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  /**
  ...
  public char nextChar ( ) {
    char returnValue = '\0' ;
    try { returnValue = scanner.findWithinHorizon ( "(?s).", 1 ).charAt ( 0 ) ; }
  ...
  public boolean hasNextInt ( ) {
    boolean returnValue = false ;
    try { returnValue = scanner.hasNextInt ( ) ; }
    catch ( IllegalStateException e ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  /**
  ...
  public int nextInt ( ) {
    int returnValue = 0 ;
    try { returnValue = scanner.nextInt ( ) ; }
    catch ( InputMismatchException ime ) { inputMismatchExceptionHandler ( "int" ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  ...
  public int nextInt ( final int radix ) {
    int returnValue = 0 ;
    try { returnValue = scanner.nextInt ( radix ) ; }
    catch ( InputMismatchException ime ) { inputMismatchExceptionHandler ( "int" ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  ...
  public boolean hasNextLong ( ) {
    boolean returnValue = false ;
    try { returnValue = scanner.hasNextLong ( ) ; }
    catch ( IllegalStateException e ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  /**
  ...
  public long nextLong ( ) {
    long returnValue = 0 ;
    try { returnValue = scanner.nextLong ( ) ; }
    catch ( InputMismatchException ime ) { inputMismatchExceptionHandler ( "long" ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  ...
  public long nextLong ( final int radix ) {
    long returnValue = 0 ;
    try { returnValue = scanner.nextLong ( radix ) ; }
    catch ( InputMismatchException ime ) { inputMismatchExceptionHandler ( "long" ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  ...
  public boolean hasNextBigInteger ( ) {
    boolean returnValue = false ;
    try { returnValue = scanner.hasNextBigInteger ( ) ; }
    catch ( IllegalStateException e ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  /**
  ...
  public BigInteger nextBigInteger ( ) {
    ...
    try { returnValue = scanner.nextBigInteger ( ) ; }
    catch ( InputMismatchException ime ) { inputMismatchExceptionHandler ( "BigInteger" ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  ...
  public BigInteger nextBigInteger ( final int radix ) {
    BigInteger returnValue = new BigInteger ( "0" ) ;
    try { returnValue = scanner.nextBigInteger ( radix ) ; }
    catch ( InputMismatchException ime ) { inputMismatchExceptionHandler ( "BigInteger" ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  ...
  public boolean hasNextFloat ( ) {
    boolean returnValue = false ;
    try { returnValue = scanner.hasNextFloat ( ) ; }
    catch ( IllegalStateException e ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  /**
  ...
  public float nextFloat ( ) {
    float returnValue = 0 ;
    try { returnValue = scanner.nextFloat ( ) ; }
    catch ( InputMismatchException ime ) { inputMismatchExceptionHandler ( "float" ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  ...
  public boolean hasNextDouble ( ) {
    boolean returnValue = false ;
    try { returnValue = scanner.hasNextDouble ( ) ; }
    catch ( IllegalStateException e ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  /**
  ...
  public double nextDouble ( ) {
    ...
    try { returnValue = scanner.nextDouble ( ) ; }
    catch ( InputMismatchException ime ) { inputMismatchExceptionHandler ( "double" ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  ...
  public boolean hasNextBigDecimal ( ) {
    boolean returnValue = false ;
    try { returnValue = scanner.hasNextBigDecimal ( ) ; }
    catch ( IllegalStateException e ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  /**
  ...
  public BigDecimal nextBigDecimal ( ) {
    ...
    try { returnValue = scanner.nextBigDecimal ( ) ; }
    catch ( InputMismatchException ime ) { inputMismatchExceptionHandler ( "BigDecimal" ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  ...
  public boolean hasNextLine ( ) {
    boolean returnValue = false ;
    try { returnValue = scanner.hasNextLine ( ) ; }
    catch ( IllegalStateException e ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
  /**
  ...
  public String nextLine ( ) {
    String returnValue = null ;
    try { returnValue = scanner.nextLine ( ) ; }
    catch ( NoSuchElementException nsee ) { noSuchElementHandler ( ) ; }
    catch ( IllegalStateException ise ) { illegalStateExceptionHandler ( ) ; }
    return returnValue ;
  }
